...
export type FriendOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"senderId" | "receiverId" | "status" | "createdAt", ExtArgs["result"]["friend"]>
...
export interface FriendDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const friendWithSenderIdOnly = await prisma.friend.findMany({ select: { senderId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Friends and only return the `senderId`
   * const friendWithSenderIdOnly = await prisma.friend.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Friends and only return the `senderId`
   * const friendWithSenderIdOnly = await prisma.friend.updateManyAndReturn({
   *   select: { senderId: true },
   *   where: {
   *     // ... provide filter here
   *   },
